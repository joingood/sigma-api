...
export default {
    ...
    methods: {
        ...
        save(){
            ...
            this.$http.put(window.__sigma.URL_REQUEST("roomType/update"), this.form)
            .then(response=>{
                //console.log( response.body );
                if(response.body.Error == 0){
                    M.toast({html: 'El tipo de hotel se actualizo exitosamente!'}); //mostrando un mensaje de exito
                    setTimeout(()=>{
    ...
    created(){
        ...
        this.$http.get(window.__sigma.URL_REQUEST("roomType/getById"), {params: {Id: this.form.Id}})
        .then(response=>{
